...
typedef struct Op_struct : public Trace_op{
  ...
  uint32_t  op_pool_id; 
  bool valid;
  bool pseudo_op;    // Inserting TLB miss pte request into MSHR
  int64_t vpn;       // For inserting tlb miss pte request requires vpn
...
extern tlb *dtlb;        // NEW-LAB3 (student need to intialize)
#endif
